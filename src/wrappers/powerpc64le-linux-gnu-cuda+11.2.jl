# Autogenerated wrapper script for CUDA_loader_jll for powerpc64le-linux-gnu-cuda+11.2
export compute_sanitizer, libcublas, libcudadevrt, libcufft, libcupti, libcurand, libcusolver, libcusolverMg, libcusparse, libdevice, libnvtoolsext, nvdisasm
